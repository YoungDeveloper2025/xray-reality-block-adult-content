...
curl -s https://raw.githubusercontent.com/YoungDeveloper2025/xray-reality-block-adult-content/master/default.json > config.json
...
json=$(curl -s https://raw.githubusercontent.com/YoungDeveloper2025/xray-reality-block-adult-content/master/config.json)
